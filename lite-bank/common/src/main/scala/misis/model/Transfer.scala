...
case class TransferPrepare(from: Int, to: Int, amount: Int, category: Option[String], id: UUID = UUID.randomUUID()) extends Command
case class TransferStart(from: Int, to: Int, amount: Int, fee: Int, category: Option[String], id: UUID) extends Command
